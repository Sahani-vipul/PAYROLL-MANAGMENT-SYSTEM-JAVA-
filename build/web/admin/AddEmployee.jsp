...
%>
<mt:admin_template title="Add Employee">
        ...
        <form action="InsertEmp.jsp" method="POST">
            ...
            <div class="grid xl:grid-cols-2 xl:gap-6">
                <div class="relative z-0 mb-2 w-full group">
                    ...
                    <input type="date" name="date_of_joing" id="date_of_joing" class="datepicker block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b border-gray-300 appearance-none dark:text-slate-300 dark:border-slate-700 dark:focus:border-primary-500 focus:outline-none focus:border-primary-500" />
