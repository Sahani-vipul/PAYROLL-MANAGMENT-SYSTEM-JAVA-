...
%>
<mt:admin_template title="Department">
    <jsp:attribute name="content">
        ...
        <div class="flex flex-wrap gap-4 mb-3">
            ...
            <div>
                <a href="AddDepartment.jsp" class="inline-block focus:outline-none bg-brand-500 mt-1 text-white hover:bg-brand-600 hover:text-white  text-md font-medium py-2 px-4 rounded">  
                    Add Department
                </a>
            </div>
        </div>
           ...
           <c:forEach var="dept" items="${departments}">
                <tr class="bg-white border-b border-dashed dark:bg-gray-900 dark:border-gray-700/40">
                    ...
                    <td class="p-3 text-sm text-gray-500 whitespace-nowrap dark:text-gray-400">
                        ...
                        <a href="DeleteDepartment.jsp?id=${dept.getDepartmentId()}"><i class="icofont-ui-delete text-lg text-red-500 dark:text-red-400"></i></a>
                    </td>
                </tr>
