<%-- 
    Document   : ViewSalaryDetail
    Created on : Nov 13, 2024, 2:48:32?PM
    Author     : SAHANI VIPUL
--%>
...
<mt:hr_template title="Salary Details">
    <jsp:attribute name="content">

        <form action="PaySalary.jsp" method="POST" class="space-y-4"> <!-- Assuming you're updating in UpdateEmployee.jsp -->
            ...
            <div class="grid xl:grid-cols-2 xl:gap-6">
                ...
                <div class="flex items-center mb-2 w-full">
                    ...
                    <select id="default" name="departmentId" class="form-input w-3/4">
            ...
            <div class="grid xl:grid-cols-2 xl:gap-6">
                <div class="flex items-center mb-2 w-full">
                    <label for="date_of_joining" class="w-1/4 text-right mr-4">Pay Date:</label>
                    <input type="date" name="date" id="date" class="form-input w-3/4" />
                </div>
                <div class="flex items-center mb-2 w-full">
                    <label for="floating_salary" class="w-1/4 text-right mr-4">Basic Salary:</label>
                    <input type="text" readonly name="basic_salary" value="${employee.basicSalary}" class="form-input w-3/4" placeholder=" " required />
                </div>
            </div>
            <div class="grid xl:grid-cols-2 xl:gap-6">
                <div class="flex items-center mb-2 w-full">
                    <label for="floating_first_name" class="w-1/4 text-right mr-4">Allowance: </label>
                    <input type="text" name="allowance" value="0" id="floating_first_name" class="form-input w-3/4" placeholder=" " required />
                </div>
                <div class="flex items-center mb-2 w-full">
                    <label for="floating_last_name" class="w-1/4 text-right mr-4">Deductions: </label>
                    <input type="text" name="deductions" value="0" id="floating_last_name" class="form-input w-3/4" placeholder=" " required />
                </div>
            </div>    
