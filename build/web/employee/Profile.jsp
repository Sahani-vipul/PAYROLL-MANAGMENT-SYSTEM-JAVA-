<%-- 
    Document   : Profile
    Created on : Dec 2, 2024, 3:53:06?PM
    Author     : SAHANI VIPUL
--%>
...
<mt:employee_template title="Profile">
    <jsp:attribute name="content">

        <form action="EditEmployee.jsp" method="POST" class="space-y-4"> <!-- Assuming you're updating in UpdateEmployee.jsp -->
            ...
            <div class="grid xl:grid-cols-2 xl:gap-6">
                <div class="flex items-center mb-2 w-full">
                    ...
                    <input type="text" name="firstName" value="${employee.firstName}" id="floating_first_name" class="form-input w-3/4" placeholder=" " readonly />
                </div>
                <div class="flex items-center mb-2 w-full">
                    <label for="floating_last_name" class="w-1/4 text-right mr-4">Last name:</label>
                    <input type="text" name="lastName" value="${employee.lastName}" id="floating_last_name" class="form-input w-3/4" placeholder=" " readonly />
                </div>
            </div>
            ...
            <div class="grid xl:grid-cols-2 xl:gap-6">
                <div class="flex items-center mb-2 w-full">
                    ...
                    <input type="email" name="email" value="${employee.email}" class="form-input w-3/4" placeholder=" " readonly />
                </div>
                <div class="flex items-center mb-2 w-full">
            ...
            <div class="grid xl:grid-cols-2 xl:gap-6">
                <div class="flex items-center mb-2 w-full">
                    ...
                    <input type="tel" name="phone" value="${employee.phone}" class="form-input w-3/4" placeholder=" " readonly />
                </div>
                <div class="flex items-center mb-2 w-full">
