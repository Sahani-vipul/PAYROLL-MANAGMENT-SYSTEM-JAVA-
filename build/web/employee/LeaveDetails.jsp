<%-- 
    ...
    Created on : Dec 13, 2024, 3:30:07 PM
    Author     : SAHANI VIPUL
--%>
...
<%
  ...
  int remainingLeave = Integer.parseInt(request.getParameter("remainingLeave"));
   ...
   // List<LeaveType> leave = LeaveDao.getAllLeaves();
    List<Leave> leave = LeaveDao.getEmployeeLeaveDetails(employeeId, leaveTypeId);
...
<mt:employee_template title="Leave Deatils">
    <jsp:attribute name="content">
        ...
        <div class="flex flex-wrap gap-4 mb-3">
            ...
            <div>
                <a href="TackLeave.jsp?id=${leaveTypeId}&remainingLeave=${remainingLeave}" class="inline-block focus:outline-none bg-brand-500 mt-1 text-white hover:bg-brand-600 hover:text-white  text-md font-medium py-2 px-4 rounded">  
                    Tack Leave
                </a>
            </div>
        <!--</div>-->
