<%-- 
    Document   : hr_template
    Created on : Nov 3, 2024, 11:52:38 AM
    Author     : SAHANI VIPUL
--%>
                ...
                <div class="me-2  dropdown relative">
                  <button
                    ...
                    <span class="ltr:ms-2 rtl:ms-0 rtl:me-2 hidden text-left xl:block">
                      ...
                      <span class="-mt-0.5 block text-xs text-slate-500 dark:text-gray-400">HR</span>
                    </span>
                  </button>
...
"https://cdnjs.cloudflare.com/ajax/libs/html2pdf.js/0.9.2/html2pdf.bundle.min.js">
    ...
    const filename = 'Report.pdf'; // The name of the downloaded file

    try {
        const content = document.getElementById('my-table'); // The table to be downloaded as a PDF
        ...
        const opt = {
            ...
            html2canvas: {
                scale: 2, // Increases the resolution of the generated image
                letterRendering: true, // Helps in rendering the font accurately
                logging: true, // Optionally log the rendering process to debug
            },
            jsPDF: {
