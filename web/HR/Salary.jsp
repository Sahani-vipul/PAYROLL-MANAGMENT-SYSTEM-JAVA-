<%-- 
    Document   : Salary
    Created on : Nov 11, 2024, 3:33:11 PM
    Author     : SAHANI VIPUL
--%>
                ...
                <c:forEach var="emp" items="${employees}">
                    <c:if test="${emp.getRole() != 'HR'}">
                        ...
                        <tr class="bg-white border-b border-dashed dark:bg-gray-900 dark:border-gray-700/40">
                            ...
                            <td class="p-3 text-sm text-gray-500 whitespace-nowrap dark:text-gray-400">
                            <a href="EmployeeSalaryDetail.jsp?id=${emp.getEmployeeId()}" class="inline-block focus:outline-none bg-brand-500 mt-1 text-white hover:bg-brand-600 hover:text-white  text-md font-medium py-2 px-4 rounded">  
                                View
                            </a>
                        </td>
                        </tr>
