...
<mt:admin_template title="Edit Employee">
    <jsp:attribute name="content">
        ...
        <form action="UpdateEmployee.jsp" method="POST" class="space-y-4"> <!-- Assuming you're updating in UpdateEmployee.jsp -->
            ...
            <div class="grid xl:grid-cols-2 xl:gap-6">
                ...
                <div class="flex items-center mb-2 w-full">
                    <label for="department_id" class="w-1/4 text-right mr-4">Department:</label>
                    <select name="departmentId" class="form-input w-3/4">
            ...
            <div class="grid xl:grid-cols-2 xl:gap-6">
                ...
                <div class="flex items-center mb-2 w-full">
                    ...
                    <input type="text" name="basic_salary" value="${employee.basicSalary}" class="form-input w-3/4" placeholder=" " required />
                </div>
            </div>
