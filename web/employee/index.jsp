<%-- 
    Document   : index
    Created on : Nov 3, 2024, 11:55:25 AM
    Author     : SAHANI VIPUL
--%>

<%@page contentType="text/html" pageEncoding="UTF-8" isELIgnored="false"  import="bean.EmployeeDao, bean.LeaveDao" %>
<%
int totalEmployees = EmployeeDao.getTotalEmployee();
request.setAttribute("totalEmployees", totalEmployees);

int totalleave = LeaveDao.getTotalLeave();
request.setAttribute("totalleave", totalleave);
%>
<%@taglib prefix="mt" tagdir="/WEB-INF/tags"%>
<mt:employee_template title="dashboard" >
                ...
                <div class="flex-auto p-4">
                    <div class="flex justify-between xl:gap-x-2 items-cente">
                        <div class="self-center"> 
                            <p class="text-gray-800 font-semibold dark:text-slate-400 text-lg uppercase">Total Employees</p>                           
                            <h3 class="my-4 font-semibold text-[30px] dark:text-slate-200">${totalEmployees}</h3>                                                
                        </div>                                       
                        <div class="self-center">                                                
        ...
        <div class="col-span-12 sm:col-span-12 md:col-span-6 lg:col-span-3 xl:col-span-3">
            <div class="bg-white shadow-sm dark:shadow-slate-700/10 dark:bg-gray-900  rounded-md w-full relative mb-4">
                <div class="flex-auto p-4">
                    <div class="flex justify-between xl:gap-x-2 items-cente">
                        <div class="self-center"> 
                            <p class="text-gray-800 font-semibold dark:text-slate-400 uppercase">Leaves Applications</p>                           
                            <h3 class="my-4 font-semibold text-[30px] dark:text-slate-200">${totalleave}</h3>                                              
                        </div>                                       
                        <div class="self-center">                                                
